...
//        return;
    ...
    render() {
        ...
        str=this.state.ar.map((x) => (
            <div className="array-bar" key={ctr1++ + 'e'} style={{backgroundColor: '#67fde4',height: `${x}px`, width:`${width}px`}}> </div>
            ))
        else
        str=this.state.ar.map((x) => (
            <div className="array-bar" key={ctr1++ + 'w'} style={{backgroundColor: '#67fde4',height: `${x}px`, width:`${width}px`, transform:'translateX(0px)', transition:`transform ${this.state.delay}ms linear,height 0.1s linear`}}> </div>
            ))
        return (
            <center>
            ...
            <button className="btn btn-outline-secondary" onClick={()=>this.bubbleSort()} id='bubblesort'>Bubble Sort</button>
            <button className="btn btn-outline-secondary" onClick={()=>this.selectionSort()} id='selectionsort'>Selection Sort</button>
            <button className="btn btn-outline-secondary" onClick={()=>this.insertionSort()} id='insertionsort'>Insertion Sort</button>
            <button className="btn btn-outline-secondary" onClick={()=>this.mergeSort()} id='mergesort'>Merge Sort</button>
            <button className="btn btn-outline-secondary" onClick={()=>this.quickSort()} id='quicksort'>Quick Sort</button>
            <button className="btn btn-outline-warning" onClick={()=>this.resetArray()} id='reset'>Reset Values</button>
            <button className="btn btn-outline-warning" onClick={()=>this.skipAnimations()} id='skip'>Skip</button>
            </div>
            <div className="col-md-3 box">
            <div>
            <span>No. of bars </span>
            <input type="range"  min={1} max={maxn} defaultValue={1} onChange={()=>this.changeArrSize()} className="slider" id="arr_size"/>
            <span style={{backgroundColor:'rgb(212, 210, 231)'}}> {this.state.n}&nbsp;
            </span>
            </div>
            </div>
            <div className="col-md-3 box">
            ...
            <span style={{backgroundColor:'rgb(212, 210, 231)',}}> {strdly}&nbsp;</span>
            </div>
